...
public class LendsABM extends ABMBase implements ABMDatabaseDataMgr {

	public static Intent getIntent(Context context) {
		return new Intent(context, LendsABM.class);
	}
	...
	public static final String DATABASE_NAME = "LENDS";
